...
do
    ...
    do
        ...
        local function update_cfgs()
            all_cfgs = listfiles("Emerald\\")
            for _,cfg in next, all_cfgs do
                all_cfgs[_] = string.gsub(string.gsub(cfg, "Emerald\\", ""), ".txt", "")
    ...
    do
        ...
        Line.Visible = false
        Line.Transparency = 1
        Line.Color = Color3.new(80,200,120)
        Line.Thickness = 1
        Line.ZIndex = 1
    ...
    do
        ...
        fov.element("Toggle", "draw fov", nil, function(State) Circle.Visible = State.Toggle end):add_color({Color = Color3.fromRGB(80, 200, 120)}, nil, function(State) Circle.Color = State.Color end)
    ...
    do
        ...
        oof.element("Toggle", "enemies"):add_color({Color = Color3.fromRGB(80, 200, 120)})
        oof.element("Toggle", "teammates"):add_color({Color = Color3.fromRGB(80, 200, 120)})
        ...
        chams.element("Toggle", "enemies", nil, UpdateChams):add_color({Color = Color3.fromRGB(80, 200, 120)}, false, UpdateChams)
